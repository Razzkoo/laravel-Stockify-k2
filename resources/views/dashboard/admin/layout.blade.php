                ...
                <div class="flex-1 px-3 space-y-1 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <ul class="pb-2 space-y-2">
                       ...
                       <li>
                            <button type="button"
                                ...
                                <svg class="w-6 h-6 text-gray-500 transition
                                    ...
                                    <path stroke="currentColor" stroke-linecap="round" stroke-width="2"
                                        d="M4.5 17H4a1 1 0 0 1-1-1
                                            3 3 0 0 1 3-3h1
                                            m0-3.05A2.5 2.5 0 1 1 9 5.5
                                            M19.5 17h.5a1 1 0 0 0 1-1
                                            3 3 0 0 0-3-3h-1
                                            m0-3.05a2.5 2.5 0 1 0-2-4.45
                                            m.5 13.5h-7a1 1 0 0 1-1-1
                                            3 3 0 0 1 3-3h3
                                            a3 3 0 0 1 3 3
                                            1 1 0 0 1-1 1Zm-1-9.5
                                            a2.5 2.5 0 1 1-5 0
                                            2.5 2.5 0 0 1 5 0Z"/>
                                </svg>
                                <span class="flex-1 ml-3 text-left whitespace-nowrap">
                            ...
                            <!-- DROPDOWN -->
                            <ul id="dropdown-user" class="hidden py-2 space-y-2 pl-11">
                                <li>
